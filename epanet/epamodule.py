...
# WARNINGS:
# a) This module could be not portable and you may need to edit it properly.
# b) This module has not been tested in all the platforms.
# c) This modules is configured to be executed externally, trying to run it
#    directly will cause some 'not found' errors
...
if _plat == 'Linux':
    # For Linux
    libpath = cwd + "/epanet/libepanet2/linux/lib/"
    name = "libepanet2"
    _lib = ctypes.CDLL(libpath + name)
elif _plat == 'Windows':
    # For MS Windows
    libpath = cwd + "/epanet/libepanet2/windows/lib/"
    name = "libepanet2"
    try:
        ...
        try:
            ...
            raise Exception(libpath + name + "not suitable")
elif _plat == 'Darwin':
    # For MacOS
    libpath = cwd + "/epanet/libepanet2/macos/"
    name = "libepanet.dylib"
    _lib = ctypes.CDLL(libpath + name)
else:
